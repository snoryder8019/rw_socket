...
import greeces from './greeces/greeces.js';
import dollywoods from './dollywoods/dollywoods.js';
import alaskas from './alaskas/alaskas.js';
import club1s from './club1s/club1s.js';
...
router.use('/alaskas', alaskas);
router.use('/dollywoods', dollywoods);
router.use('/greeces', greeces);
router.use('/club1s', club1s);
