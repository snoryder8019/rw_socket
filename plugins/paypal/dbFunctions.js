...
export const saveOrUpdateOrderForPaypal = async (customId, additionalData) => {
  try {
    const db = getDb();
    ...
    const savedOrder = await ordersPaypal.findOne({
...
export const getUserforPaypal = async (userId) => {
  try {
    const db = getDb();
...
export const getCardforPaypal = async (cardId) => {
  try {
    const db = getDb();
...
export const getOrderforPaypal = async (orderId) => {
  try {
    const db = getDb();
...
export const updatePaypalOrder = async (orderId, updateFields) => {
